...
from ari_core.decision.controller import DecisionController  # noqa: E402
from ari_core.modules.decision.dispatch import DispatchResult  # noqa: E402
from ari_core.modules.decision.persistence import PersistedDecisionTrail  # noqa: E402
from ari_state import Alert, AlertChannel, EvidenceItem, OrchestrationRun, Signal  # noqa: E402
    ...
    def list_recent(self, limit=100):
        ...
        return [
            Signal(
                ...
                detected_at=datetime(2026, 4, 21, 8, 0, tzinfo=UTC),
            )
        ]
...
def test_run_signal_orchestration_emits_decisions_before_alerts(monkeypatch) -> None:
    ...
    result = orchestration_module.run_signal_orchestration(
        ...
        orchestration_input=orchestration_module.RunSignalOrchestrationInput(
            ...
            detected_at=datetime(2026, 4, 22, 9, 0, tzinfo=UTC),
