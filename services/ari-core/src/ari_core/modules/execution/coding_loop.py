...
def approve_latest_pending_coding_loop_retry_approval(
    ...
    *,
    ...
    from .coding_loop_chain import approve_latest_pending_coding_loop_retry_approval as approve
...
def reject_latest_pending_coding_loop_retry_approval(
    ...
    *,
    ...
    from .coding_loop_chain import reject_latest_pending_coding_loop_retry_approval as reject
...
def propose_next_coding_loop_retry_approval_from_chain(
    ...
    *,
    ...
    from .coding_loop_chain import propose_next_coding_loop_retry_approval_from_chain

    return propose_next_coding_loop_retry_approval_from_chain(
        result_id,
        max_depth=max_depth,
        db_path=db_path,
    )
...
def advance_coding_loop_retry_chain(
    ...
    *,
    ...
    from .coding_loop_chain import advance_coding_loop_retry_chain as advance
